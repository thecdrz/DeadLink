  ...
  getGuide(os = 'windows', versionTag = null) {
    ...
    if (os === 'linux') {
      return [
        ...
        'Download: curl -L https://github.com/' + this.repoAuthor + '/' + this.repoName + '/archive/refs/tags/' + tag + '.tar.gz -o HordeComms.tar.gz',
        'Extract: mkdir -p ../HordeComms-' + tag + ' && tar -xzf HordeComms.tar.gz -C ..',
    ...
    return [
      ...
      'Download: Invoke-WebRequest https://github.com/' + this.repoAuthor + '/' + this.repoName + '/archive/refs/tags/' + tag + '.zip -OutFile HordeComms.zip',
