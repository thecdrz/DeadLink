...
> Note: For the authoritative configuration shape and runtime defaults, see `lib/configSchema.js`. The examples below are illustrative; prefer the schema for exact validation rules.
